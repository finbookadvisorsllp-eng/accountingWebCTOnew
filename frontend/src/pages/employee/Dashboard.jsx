    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-accent-50">
      ...
      <div className="container mx-auto px-6 py-12 max-w-6xl">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-primary-100 text-lg">
                Employee ID: {candidate.adminInfo?.employeeId}
              </p>
            </div>
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="font-semibold text-lg">
                  {candidate.adminInfo?.designation || "N/A"}
                </p>
              </div>
              <div>
        ...
        {candidate.status === "APPROVED" &&
          !candidate.finalConfirmation?.finalDigitalConfirmation && (
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-700 mb-4">
                    Please review your profile information above carefully. Once
                    you confirm, your profile will be activated and you'll be
                    officially onboarded as an employee.
                  </p>
                  <div className="space-y-3 mb-6">
                    <label className="flex items-start space-x-3 cursor-pointer">
                      <input
                        type="checkbox"
                        className="mt-1 w-5 h-5 text-primary-600 border-gray-300 rounded"
                      />
                      <span className="text-gray-700">
                        I have reviewed all my information and confirm it is
                        accurate
                      </span>
                    </label>
                    <label className="flex items-start space-x-3 cursor-pointer">
                      ...
                      />
                      <span className="text-gray-700">
                        I understand that this action will finalize my
                        onboarding process
                      </span>
                    </label>
                  </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-700 mb-2">
                  Congratulations! Your profile has been successfully activated.
                  Welcome to the AccounTech Advisory team!
                </p>
                <p className="text-sm text-gray-600">
                  Activated on:{" "}
                  {candidate.finalConfirmation?.confirmedAt
                    ? new Date(
                        candidate.finalConfirmation.confirmedAt,
                      ).toLocaleDateString()
                    : "N/A"}
