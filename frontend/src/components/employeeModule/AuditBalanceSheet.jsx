  ...
  return (
    <div className="flex-1 overflow-y-auto bg-[#F9FBFB] scrollbar-hide w-full h-full pb-8">
      ...
      <header className="flex items-center space-x-4 px-6 md:px-10 py-6 md:py-8 bg-white sticky top-0 z-30 border-b border-slate-100 shadow-sm">
        ...
        />
        <h1 className="text-2xl md:text-3xl font-bold text-slate-800">Audit Balance Sheet</h1>
      </header>
        ...
        <div className="space-y-6 relative z-10">
          ...
          <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm">
             <div className="bg-white px-5 py-4 border-b border-slate-100 flex items-center justify-between">
                <h3 className="font-bold text-slate-800">Balance Sheet (Final)</h3>
             ...
             <div className="p-5 space-y-3">
                ...
                <DetailRow label="Total Assets" value="₹1,50,00,000" />
                <DetailRow label="Total Liabilities" value="₹1,50,00,000" />
                <DetailRow label="Status" value="Audited & Signed" />
             </div>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm">
             ...
             <div className="p-5 space-y-3">
                <DetailRow label="Total Revenue" value="₹75,50,000" />
                <DetailRow label="Total Expenses" value="₹45,20,000" />
                <DetailRow label="Net Profit" value="₹30,30,000" />
             </div>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm">
             <div className="bg-white px-5 py-4 border-b border-slate-100 flex items-center justify-between">
                <h3 className="font-bold text-slate-800">Audit Report Copy</h3>
                <div className="flex items-center space-x-2">
                   <button className="p-1.5 bg-slate-100 text-slate-600 rounded cursor-pointer hover:bg-slate-200"><Eye size={18} /></button>
                   <button className="p-1.5 bg-slate-100 text-slate-600 rounded cursor-pointer hover:bg-slate-200"><Download size={18} /></button>
                </div>
             ...
             <div className="p-5 space-y-3">
                <DetailRow label="Auditing Firm" value="ABC & Associates" />
                <DetailRow label="Date of Audit" value="25-Aug-2024" />
                <DetailRow label="UDIN Number" value="24123456AAAAAA1234" />
             </div>
          </div>
...
export default AuditBalanceSheet;
